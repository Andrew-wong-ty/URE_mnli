...
from URE_mnli.relation_classification.utils import find_uppercase
...
if arguments.dataset=="tac":
    ...
    with open(args.input_file, "rt") as f:  #输出features, labels, relations,subj_pos,obj_pos
...
for configuration in config:
    ...
    # save(template2label,"/home/tywang/myURE/URE/WIKI/typed/train_template2label.pkl")
    ...
    if arguments.generate_data:
        ...
        dataset, etags = get_format_train_text(dataset,mode='wiki',return_tag=True)
        ...
        # elif arguments.dataset=="wiki":
        #     save(dataset,"/home/tywang/myURE/URE_mnli/temp_files/analysis_0.01510/wiki_{}_num{}_top1_{:.4f}_Xlarge.pkl".format(arguments.mode,len(dataset['text']),top1_acc))
